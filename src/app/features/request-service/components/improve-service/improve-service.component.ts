...
@Component({
  ...
  template: `<main class="p-0 mx-auto my-0 w-full max-w-[1290px]">
    <header class="flex flex-col items-center py-6">
      <div class="flex items-center">
        <h1 class="mb-2.5 text-4xl font-bold text-center max-sm:text-3xl">
          <span class="text-indigo-950">
            {{ 'servicePage.improve.preTitle' | translate }}
          </span>
          <span class="text-amber-600">
            {{ 'servicePage.improve.postTitle' | translate }}</span
          >
        </h1>
        <div class="mb-2.5">
          <svg
      ...
      >
        {{ 'servicePage.improve.subTitle' | translate }}
      </p>
    </header>
    ...
    >
      ...
      >
        ...
        <div>
          ...
          >
            {{ 'servicePage.improve.1main' | translate }}
          </h2>
          <p class="text-xl leading-8 text-neutral-600 max-sm:text-base">
            {{ 'servicePage.improve.1sub' | translate }}
          </p>
        </div>
      </article>
      ...
      >
        ...
        <div>
          <h2
            class="mb-2.5 text-2xl font-semibold text-slate-800 max-sm:text-xl"
          >
            {{ 'servicePage.improve.2main' | translate }}
          </h2>
          <p class="text-xl leading-8 text-neutral-600 max-sm:text-base">
            {{ 'servicePage.improve.2sub' | translate }}
          </p>
        </div>
      </article>
      ...
      >
        ...
        <div>
          <h2
            class="mb-2.5 text-2xl font-semibold text-slate-800 max-sm:text-xl"
          >
            {{ 'servicePage.improve.3main' | translate }}
          </h2>
          <p class="text-xl leading-8 text-neutral-600 max-sm:text-base">
            {{ 'servicePage.improve.3sub' | translate }}
          </p>
        </div>
      </article>
    </section>
...
export class ImproveServiceComponent {}
